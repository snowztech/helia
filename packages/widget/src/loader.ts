...
import { fetchAndSetIdentity } from "./identity";
import type { WidgetConfig } from "./types";
export { default, mount } from "./index";
export type { Identity, WidgetConfig, WidgetHandle } from "./index";
...
function autoMount(): void {
  ...
  const mode =
    (script.getAttribute("data-mode") as WidgetConfig["mode"]) ?? undefined;
